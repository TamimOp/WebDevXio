...
const Button = ({ label = "Contact Us", Icon, onClick, className = "" }) => (
  <div className="inline-flex items-center justify-center rounded-[30px] p-[2px] bg-gradient-to-r from-[#0634FF] to-[#B2ACFF] shadow-lg shadow-[#B2ACFF]">
    <button
